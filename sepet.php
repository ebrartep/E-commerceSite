...
<div class="container">
  ...
  <form  action="nedmin/netting/islem.php" method="POST" enctype="multipart/form-data">
              ...
              <input type="hidden" name="sepet_id" value="<?php echo $_GET['sepet_id']; ?>">


	<div align="right" class="col-md-12">
                  <button type="submit" name="urunsepetsil"  class="btn btn-danger "><i class="fa fa-trash" aria-hidden="true"></i> Seçilenleri Sil</button></div>
	<div class="table-responsive">
			...
			<tbody>
				...
				while($sepetcek=$sepetsor->fetch(PDO::FETCH_ASSOC)) {
					...
					?>
						...
						<td> <?php  array("$urunsec"); ?>


                    <input type="checkbox" name="urunsec[]"  value="<?php echo $sepetcek['sepet_id']; ?>" > Seç</form></td>
						<td><img width="100" height="50" src="<?php echo $urunfotocek["urunfoto_resimyol"] ?>"  alt="" class="img-responsive"></td>
		...
		<div class="row">
			...
			<div align="right" class="col-md-9 col-md-offset-3">
