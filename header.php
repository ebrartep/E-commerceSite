...
<!-- Animate CSS -->
  <link rel="stylesheet" type="text/css" href="css/animate.css">
   ...
   <link rel="Shortcut Icon"  href="images/ufo.png"  type="image/x-icon">
    ...
    <body>
     <div id="wrapper">
      <div class="header"  style="background-image: url(arkaplan7.png)"><!--Header -->
       <div class="container">
        <div class="row">
         <div class="col-xs-6 col-md-4 main-logo animated shake">
          <a href="index.php"><img width="100" height="70" alt="Site Logosu" class="logo img-responsive" src="<?php echo $ayarcek['ayar_logo'] ?>"></a>
        </div>
       ...
       <div class="srchwrap">
         <div class="row">
          ...
          <button class="btn btn-default " name="arama">Ara</button>
             <div class="col-sm-10">
              <input type="text" name="aranan" minlength="3" maxlength="" class="form-control" id="search">
            </div>
          </div>
        </form>
      </div>
...
<?php  
       ...
       <a href="urun-<?=seo($uruncek["urun_ad"]).'-'.$uruncek["urun_id"]?>"><img width="50" height="50" src="<?php echo $urunfotocek["urunfoto_resimyol"] ?>" alt="" class="img-responsive"></a>
      </td>
