...
<div class="right_col" role="main">
 ...
 <!--<form action="netting/islem.php" method="POST">
                      Resim Sırası : <input type="number" name="urunfoto_sira" value="<?php echo $urunfotocek['urunfoto_sira'] ?>" style="width:40px;">
                      <input type="hidden" name="urunfoto_id" value="<?php echo $urunfotocek['urunfoto_id'] ?>">
                      <input type="hidden" name="urun_id" value="<?php echo $urunfotocek['urun_id'] ?>">
                      <button name="urunfotosira">Güncelle</button>
                    </form>-->
