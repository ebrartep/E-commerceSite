      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <div align="right">
              <a href="urun-ekle.php"><button class="btn btn-success btn-xs"> Yeni Ekle</button></a></div>
...
<a href="../netting/islem.php?urun_id=<?php echo $uruncek['urun_id']  ?>&urun_one=0&urun_onecikar=iptal"><button class="btn btn-danger btn-xs">İptal</button></a>
