...
<head>
                            ...
                            <title><?php echo $kategoricek['kategori_ad'] ?>-Ebrar Tep | E-ticaret</title>
</head>
                     		...
                     		<div class="productwrap">
                     			<div class="pr-img">
                     				<div class="hot"></div>
                                                 ...
                                                 <a href="urun-<?=seo($uruncek["urun_ad"]).'-'.$uruncek["urun_id"]?>"><img width="200" height="150" src="<?php echo $urunfotocek["urunfoto_resimyol"] ?>" alt="" class="img-responsive"></a>
